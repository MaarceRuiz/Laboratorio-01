...
class HomeFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.mainThreadButton.setOnClickListener{
            findNavController().navigate((R.id.action_homeFragment3_to_mainThreadFragment2))
        }
        binding.coroutinesButton.setOnClickListener {
            findNavController().navigate(R.id.action_homeFragment3_to_coroutinesFragment2)
        }
    }
}